...
local spawn_table = function(level)
    ...
    -- Tier 2
    res[3] = { MOD_NAME..'--darktemplar--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.1 }, { 0.8, 0.25 }, { 1.0, 0.2 } } }
    --Tire 3
    res[4] = { MOD_NAME..'--templar--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.1 }, { 1.0, 0.2 } } }
...
function ErmToss.make_templar_archive(level)
    ...
    absorptions_per_second = { pollution = { absolute = pollution_absorption_absolute, proportional = 0.01 } },
            ...
            -- (2018-12-07)
            autoplace = enemy_autoplace.enemy_spawner_autoplace('enemy_autoplace_base(0, 30015)', FORCE_NAME),
