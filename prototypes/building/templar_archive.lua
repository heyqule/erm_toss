...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { MOD_NAME .. '/zealot/' .. level, { { 0.0, 0.7 }, { 0.2, 0.6 }, { 0.4, 0.5 }, { 0.6, 0.4 }, { 0.8, 0.25 }, { 1.0, 0.1 } } }
    res[2] = { MOD_NAME .. '/dragoon/' .. level, { { 0.0, 0.3 }, { 0.2, 0.4 }, { 0.4, 0.4 }, { 0.6, 0.5 }, { 0.8, 0.3 }, { 1.0, 0.1 } } }
    -- Tier 2
    res[3] = { MOD_NAME .. '/darktemplar/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.1 }, { 0.8, 0.25 }, { 1.0, 0.25 } } }
    --Tire 3
