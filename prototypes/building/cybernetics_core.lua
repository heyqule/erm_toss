...
local spawn_table = function(level)
    ...
    res[1] = { MOD_NAME..'--dragoon--' .. level, { { 0.0, 1 }, { 0.2, 1 }, { 0.4, 0.7 }, { 0.6, 0.4 }, { 0.8, 0.2 }, { 1.0, 0.25 } } }
    --Tire 2
    res[2] = { MOD_NAME..'--scout--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.15 }, { 0.6, 0.15 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    res[3] = { MOD_NAME..'--corsair--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.15 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    ...
    res[8] = { MOD_NAME..'--darkarchon--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    res[9] = { MOD_NAME..'--reaver--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    return res
end
...
function ErmToss.make_cybernetics_core(level)
    ...
    absorptions_per_second = { pollution = { absolute = pollution_absorption_absolute, proportional = 0.01 } },
            ...
            -- (2018-12-07)
            autoplace = enemy_autoplace.enemy_spawner_autoplace('enemy_autoplace_base(0, 30005)', FORCE_NAME),
