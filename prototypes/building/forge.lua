...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { ERM_TOSS.MOD_NAME.."--zealot--" .. level, { { 0.0, 0.7 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.15 } } }
    res[2] = { ERM_TOSS.MOD_NAME.."--dragoon--" .. level, { { 0.0, 0.3 }, { 0.2, 0.5 }, { 0.4, 0.35 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.15 } } }
    res[3] = { ERM_TOSS.MOD_NAME.."--scout--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    --Tire 2
    res[4] = { ERM_TOSS.MOD_NAME.."--corsair--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.2 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    res[5] = { ERM_TOSS.MOD_NAME.."--shuttle--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[6] = { ERM_TOSS.MOD_NAME.."--darktemplar--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.1 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    --Tire 3
    res[7] = { ERM_TOSS.MOD_NAME.."--templar--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    res[8] = { ERM_TOSS.MOD_NAME.."--archon--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.05 } } }
    res[9] = { ERM_TOSS.MOD_NAME.."--carrier--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    res[10] = { ERM_TOSS.MOD_NAME.."--arbiter--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    res[11] = { ERM_TOSS.MOD_NAME.."--reaver--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    res[12] = { ERM_TOSS.MOD_NAME.."--darkarchon--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    return res
end
