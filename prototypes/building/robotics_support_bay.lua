...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { MOD_NAME .. '/zealot/' .. level, { { 0.0, 0.7 }, { 0.2, 0.6 }, { 0.4, 0.45 }, { 0.6, 0.35 }, { 0.8, 0.3 }, { 1.0, 0.2 } } }
    res[2] = { MOD_NAME .. '/dragoon/' .. level, { { 0.0, 0.3 }, { 0.2, 0.3 }, { 0.4, 0.4 }, { 0.6, 0.35 }, { 0.8, 0.3 }, { 1.0, 0.2 } } }
    --Tire 2
    res[3] = { MOD_NAME .. '/scout/' .. level, { { 0.0, 0.0 }, { 0.2, 0.1 }, { 0.4, 0.1 }, { 0.6, 0.2 }, { 0.8, 0.4 }, { 1.0, 0.3 } } }
    res[4] = { MOD_NAME .. '/shuttle/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.2 }, { 1.0, 0.2 } } }
    res[5] = { MOD_NAME .. '/reaver/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.2 } } }
    ...
    res[8] = { MOD_NAME .. '/archon/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    res[9] = { MOD_NAME .. '/darkarchon/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.1 }, { 1.0, 0.05 } } }
    return res
end
