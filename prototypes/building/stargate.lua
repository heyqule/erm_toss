...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { MOD_NAME..'--zealot--' .. level,  { { 0.0, 0.7 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.3 }, { 0.8, 0.0 }, { 1.0, 0.0 } } }
    res[2] = { MOD_NAME..'--dragoon--' .. level, { { 0.0, 0.3 }, { 0.2, 0.45 }, { 0.4, 0.45 }, { 0.6, 0.2 }, { 0.8, 0.0 }, { 1.0, 0.0 } } }
    --Tire 2
    res[3] = { MOD_NAME..'--scout--' .. level,   { { 0.0, 0.0 }, { 0.2, 0.05 }, { 0.4, 0.1 }, { 0.6, 0.2 }, { 0.8, 0.35 }, { 1.0, 0.3 } } }
    res[4] = { MOD_NAME..'--corsair--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.2 }, { 0.8, 0.35 }, { 1.0, 0.3 } } }
    res[5] = { MOD_NAME..'--shuttle--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.2 }, { 1.0, 0.2 } } }
    --Tire 3
    res[6] = { MOD_NAME..'--arbiter--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    res[7] = { MOD_NAME..'--carrier--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    return res
end
...
function ErmToss.make_stargate(level)
    level = level or 1
    ...
    absorptions_per_second = { pollution = { absolute = pollution_absorption_absolute, proportional = 0.01 } },
            ...
            -- (2018-12-07)
            autoplace = enemy_autoplace.enemy_spawner_autoplace('enemy_autoplace_base(0, 30014)', FORCE_NAME),
