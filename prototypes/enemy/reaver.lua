...
function ErmToss.make_reaver(level)
    ...
    local buildable_entities = ERM_UnitHelper.get_buildable_entities(ERM_TOSS.MOD_NAME, {
        "interceptor-cannon",   "cannon","shield_battery", "pylon", "nexus", "robotics_facility", "cybernetics_core", "robotics_support_bay"
    }, level)
                ...
                ammo_type = {
                    ...
                    action = {
                        ...
                        action_delivery = {
                            ...
                            source_effects = {
                                type = "script",
                                effect_id = ERM_TOSS.REAVER_ATTACK,
                            }
                        }
                    }
                },
