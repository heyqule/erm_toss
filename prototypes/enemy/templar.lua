...
function ErmToss.make_templar(level)
    ...
    local buildable_entities = ERM_UnitHelper.get_buildable_entities(ERM_TOSS.MOD_NAME, {
        "acid-cannon", "shield_battery", "pylon", "gateway", "forge", "templar_archive", "nexus"
    }, level)
    ...
    data:extend({
        {
            ...
            attack_parameters = {
                            ...
                            target_effects = {
                                {
                                    ...
                                    entity_name = ERM_TOSS.MOD_NAME.."--psystorm-"..level
                                },
                                {
                ...
                sound = TossSound.templar_attack(0.9),
        ...
        {
            name = ERM_TOSS.MOD_NAME.."--psystorm-"..level,
