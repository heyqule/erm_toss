...
if data.raw["string-setting"]["enemyracemanager-2way-group-enemy-negative"].default_value ~= MOD_NAME then
    data.raw["string-setting"]["enemyracemanager-2way-group-enemy-negative"].default_value = MOD_NAME
end

if data.raw["string-setting"]["enemyracemanager-4way-southeast"].default_value ~= MOD_NAME then
    data.raw["string-setting"]["enemyracemanager-4way-southeast"].default_value = MOD_NAME
end