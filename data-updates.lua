...
mapgen["erm-rts-death-world"]["basic_settings"]["autoplace_controls"][ERM_TOSS.AUTOCONTROL_NAME] = { frequency = "very-high", size = "very-big" }

if mapgen["death-world"] then
    mapgen["death-world"]["basic_settings"]["autoplace_controls"][ERM_TOSS.AUTOCONTROL_NAME] = { frequency = "very-high", size = "very-big" }
end

if mapgen["erm-debug"] then
    mapgen["erm-debug"]["basic_settings"]["autoplace_controls"][ERM_TOSS.AUTOCONTROL_NAME] = { frequency = 5, size = 5 }
end
...
if map_gen_settings then
    ...
    if nauvis_enemy_settings == ERM_TOSS.MOD_NAME then
...
if mods["space-age"] then
    ...
    if settings.startup["enemy_erm_toss-on_fulgora"] and
    ...
    then
        ...
        if map_gen_settings then
            map_gen_settings.autoplace_controls[ERM_TOSS.AUTOCONTROL_NAME] = {}
        end
